...
![image](/lab1/report/img/gitclone1.png)  
![image](/lab1/report/img/shell1.png)  
3. 使用vim创建hello.c
``` bash
vim hello.c
```
![image](/lab1/report/img/vim.png)  
...
./ hello
```
![image](/lab1/report/img/shell2.png)  
...
![image](/lab1/report/img/keydenied.png)  
后来在github官网和百度的帮助下，成功解决，如图  
![image](/lab1/report/img/key2.png)  
之后的问题是写报告，学习了一下markdown语法，遇到的问题也不少。结论：看文档是万能的。  
![image](/lab1/report/img/github.png)  

## 重现实验的具体操作
删除本地目录之后，重新在github里clone项目，编译运行成功，实验成功！  
![image](/lab1/report/img/review.png)
